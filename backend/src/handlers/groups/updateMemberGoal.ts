...
export async function handler(event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
  return handleErrors(async () => {
    ...
    // Editing currentMetricValue re-baselines startingMetricValue to the same value,
    // since progress-to-date is measured from whatever the value was at edit time.
